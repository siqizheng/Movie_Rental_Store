...
// --------------------------------------------------------------
// Purpose: Serves as a data structure to hold movies. holds item info in nodes
// --------------------------------------------------------------
...
public:
	...
	void retrieveHelper(Node* curPtr, const Inventory & dataItem, Inventory*& dataFound) const;
